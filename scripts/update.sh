...
PROJECT_DIR="/root/hermes/members"
...
echo ""
echo "🏥 Health:"
curl -sf http://localhost:8082/api/health > /dev/null && echo "  Backend:  ✅" || echo "  Backend:  ❌"
curl -sf http://localhost:3003/ > /dev/null && echo "  Frontend: ✅" || echo "  Frontend: ❌"
